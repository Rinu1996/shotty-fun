...
const RedditTiktokTest = ({
  transcript,
  audioUrl
}) => {
  const frame = (0,cjs.useCurrentFrame)();
  const [videoFile, setVideoFile] = (0,react.useState)(
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, transcript.chunks.map((item) => {
    if (frame > item.start * 30 && frame < item.end * 30) {
  ...
  }), /* @__PURE__ */ React.createElement(cjs.AbsoluteFill, { style: { backgroundColor: "rgba(0,0,0,0.5)" } }, videoFile.length > 0 && /* @__PURE__ */ React.createElement(
    cjs.OffthreadVideo,
    {
      muted: true,
  ...
  )), audioUrl ? /* @__PURE__ */ React.createElement(cjs.Audio, { src: audioUrl, volume: 1 }) : null);
};
...
const RemotionRoot = () => {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    cjs.Composition,
    {
      ...
      fps: 30,
      defaultProps: {
        // audioUrl: 'http://localhost:59363/1701856018256.mp3',
        id: "IdiotsInCars-zde88x",
        script: "Hey y'all, I'm Nazeem, a software engineer from Kerala who loves creating awesome websites and supporting open source projects. One of my cool projects is Dialoqbase, a free AI chatbot platform. You can also find me on Github, Linkedin, and Bluesky. Copyright \xA9 Muhammed Nazeem 2023.",
        transcript: {
          chunks: [
            {
              start: 0,
            ...
            {
              start: 9.342,
              end: 9.649000000000001,
              text: "is"
            },
            {
              start: 9.649000000000001,
              end: 9.956,
              text: "Dialogue"
            },
            {
            ...
            {
              start: 10.877,
              end: 11.184000000000001,
              text: "AI"
            },
            {
              start: 11.184000000000001,
              end: 11.491,
              text: "chatbot"
            },
            {
              start: 11.491,
              end: 11.798000000000002,
              text: "platform."
            },
            {
              start: 11.798000000000002,
              end: 12.105,
              text: "You"
            },
            {
            ...
            {
              start: 12.412,
              end: 12.719000000000001,
              text: "also"
            },
            {
              start: 12.719000000000001,
              end: 13.026,
              text: "find"
            },
            {
              start: 13.026,
              end: 13.333000000000002,
              text: "me"
            },
            {
              start: 13.333000000000002,
              end: 13.64,
              text: "on"
            },
            {
            ...
            {
              start: 17.512,
              end: 17.996000000000002,
              text: "nozeme"
            },
            {
              start: 17.996000000000002,
              end: 18.48,
              text: "2023."
            }
          ],
          videos: [
            {
              ...
              video_file: "https://player.vimeo.com/external/463926584.hd.mp4?s=50bbd0696f16f7226e8d0689e57a90ed7c194ffa&profile_id=174&oauth2_token_id=57447761"
            },
            {
              start: 7.5,
              end: 13.64,
              video_file: "https://player.vimeo.com/progressive_redirect/playback/856360836/rendition/2160p/file.mp4?loc=external&oauth2_token_id=57447761&signature=18a61e84b9262e17c9c1d45845a9b775ecad13cb6996650d503139b707e2c3ec"
            },
            {
              start: 13.64,
              end: 18.48,
              video_file: "https://player.vimeo.com/external/597555036.hd.mp4?s=b4302e54311a0775886cc9a6a26f5bf3a97e46c4&profile_id=175&oauth2_token_id=57447761"
            }
          ]
        },
        frame: 554.4
      ...
      calculateMetadata: (props) => {
        return {
          durationInFrames: Math.round(
            props.props.frame || props.defaultProps.frame
          )
        };
      }
    }
